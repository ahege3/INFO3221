...
#three components are: data, mapping, geom
...
```{r}
bardata <- table(mpg$class, mpg$trans)
barplot(bardata, col=c("red","orange","yellow","green","blue","purple","hotpink"))
...
```{r} 
midwest_plot <- ggplot(midwest, aes(state))
midwest_plot
```
...
ncol(midwest)
dim(midwest)
#midwest data has 437 rows and 28 columns
